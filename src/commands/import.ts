...
export async function runImport(
  ...
  if (!dirArg) {
    console.error('Usage: gbrain import <dir> [--no-embed] [--workers N] [--fresh] [--source <id> | --source-id <id>] [--slug-prefix <prefix>] [--include-gitignored] [--allow-noncanonical-root] [--json]');
