...
const list_pages: Operation = {
  ...
  params: {
    ...
    slug_prefix: {
      type: 'string',
      description: 'Return only pages whose slug starts with this prefix (e.g. "ks/bourbon-county/commission/meetings/"). Indexed range scan; LIKE metacharacters are treated literally.',
    },
  },
  handler: async (ctx, p) => {
